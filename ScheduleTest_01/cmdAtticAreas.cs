...
namespace ScheduleTest_01
{
    ...
    public class cmdAtticAreas : IExternalCommand
    {
...
//public void CreateCalculatedParameter(Document doc, string scheduleName, string newParamName, ParameterType paramType, string formula)
//{
//    // Find the schedule by name
//    ViewSchedule schedule = new FilteredElementCollector(doc)
//        .OfClass(typeof(ViewSchedule))
//        .Cast<ViewSchedule>()
//        .FirstOrDefault(q => q.Name == scheduleName);

//    if (schedule == null)
//    {
//        TaskDialog.Show("Error", "Schedule not found.");
//        return;
//    }

//    ScheduleDefinition scheduleDefinition = schedule.Definition;

//    // Create the calculated parameter
//    ScheduleFieldId newFieldId = scheduleDefinition.AddCalculatedParameter(newParamName, paramType);

//    // Assuming you want to set a formula for the calculated parameter
//    ScheduleField newField = scheduleDefinition.GetField(newFieldId);
//    newField.Formula = formula;

//    // Optional: Refresh the schedule to show changes
//    schedule.RefreshData();
//    schedule.GetTableData().GetSectionData(SectionType.Header).FirstRowNumber = 1;
//}
